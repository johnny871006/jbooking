...
import { gsap } from "gsap"; //配合useRef來專門處理動畫與特效的套件
          ...
          <div className="sliderWrapper">
            ...
            <div className="wrapperBody">
              <FontAwesomeIcon
                icon={faAngleLeft}
                className="arrow"
                onClick={() => sliderDirection("left")}
              />
              <img src={photos[sliderIndex].src} alt="" />
              <FontAwesomeIcon
                icon={faAngleRight}
                className="arrow"
                onClick={() => sliderDirection("right")}
              />
            </div>
          </div>
        </div>
        ...
        <div className="hotelWrapper">
          ...
          <div className="htelTitle">
            <div className="titleLeft">
              ...
              <div className="address">
                <FontAwesomeIcon icon={faLocationDot} /> 台南中西區No. 28 Dade
                Street <a>地理位置超棒－顯示地圖</a>
              </div>
            </div>
          ...
          <div className="hotelImgWrapper">
            ...
            <div className="hotelImg">
              {/* 不管他再怎麼多 如果剛好有到7張照片就可以觀看更多，並往上加 */}
          ...
          <div className="hotelDes">
            <div className="hotelDesText">
              ...
              <br />
              預訂H& 台南微醺文旅 I老宅古城 漫遊體驗I H& tainan weshare
              hotel可享 Genius 折扣！
              <br />
              只要登入，預訂此住宿即可省一筆。 H& 台南微醺文旅
              I老宅古城漫遊體驗I H& tainan weshare hotel 位在台南，提供
              WiFi（免費）、空調、共用休息室和花園，距離台南孔廟 1.3
              公里，距離赤崁樓 1.6 公里。
